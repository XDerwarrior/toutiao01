...
public class UpdateMessageTemplateRequestTest extends TestCase {
    ...
    public void testGetRequestUrl() throws Exception {
        ...
        when(updateMessageTemplateRequest.getRequestUri()).thenCallRealMethod();
        ...
        Assert.assertEquals(requestURL, SMN_ENDPOINT  + updateMessageTemplateRequest.getRequestUri());
