...
public class ListSubscriptionsByTopicRequestTest {
    ...
    public void testGetRequestUrl() throws Exception {
        ...
        when(listSubscriptionsByTopicRequest.getRequestUri()).thenCallRealMethod();
        ...
        Assert.assertEquals(requestURL, SMN_ENDPOINT  + listSubscriptionsByTopicRequest.getRequestUri());
