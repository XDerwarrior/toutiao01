...
public class ListMessageTemplatesRequestTest extends TestCase {
    ...
    public void testGetRequestUrl() throws Exception {
        ...
        when(listMessageTemplatesRequest.getRequestUri()).thenCallRealMethod();
        ...
        Assert.assertEquals(requestURL, SMN_ENDPOINT  + listMessageTemplatesRequest.getRequestUri());
