...
public class DeleteMessageTemplateRequestTest extends TestCase {
    ...
    public void testGetRequestUrl() throws Exception {
        ...
        when(deleteMessageTemplateRequest.getRequestUri()).thenCallRealMethod();
        ...
        Assert.assertEquals(requestURL, SMN_ENDPOINT  + deleteMessageTemplateRequest.getRequestUri());
